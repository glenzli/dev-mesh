...
- `skills/observe-dev-mesh/` — thin read-only launcher for the current Observer runtime.
...
PYTHONPATH=runtime python3 -m compileall -q runtime/dev_mesh_coord runtime/dev_mesh_observer runtime/tests
