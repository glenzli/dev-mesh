...
class ObserverConsoleTest(unittest.TestCase):
    ...
    def test_serves_console_assets_with_browser_security_headers(self) -> None:
        ...
        self.assertIn(b"storyline.legend.endpointAddressed", payload)
        self.assertIn(b"storyline.legend.endpointRunContext", payload)
        self.assertIn(b"storyline.legend.endpointAcknowledged", payload)
        ...
        self.assertIn(b"crossProject.legend.overlap", payload)
        ...
        self.assertIn(b"crossProject.overlapArea", cross_project)
        self.assertIn(b"identity-overlap-area", cross_project)
        self.assertIn(b'if (relation.temporal_relation === "overlap") return', cross_project)
        ...
        self.assertIn(b"orderLanes", storyline)
        self.assertIn(b"right.open_runs", storyline)
        self.assertIn(b"storyline.laneRecent", storyline)
        ...
        self.assertIn(b"drawCommunicationEndpoints", storyline)
        self.assertIn(b"communicationApproach", storyline)
        ...
        self.assertIn(b"targetEndpoint", storyline_layout)
        ...
        self.assertIn(b"crossProject.legend.overlap", preferences)
        self.assertIn(b"crossProject.overlapArea", preferences)
        self.assertIn(b"storyline.detail.terminal_event", preferences)
        self.assertIn(b"storyline.detail.terminal_at", preferences)
        self.assertIn(b"storyline.endpoint.addressed", preferences)
        self.assertIn(b"storyline.endpoint.run-context", preferences)
        self.assertIn(b"storyline.endpoint.acknowledged", preferences)
        ...
        self.assertIn(b".communication-endpoint", stylesheet)
        self.assertIn(b".identity-overlap-area", stylesheet)
